...
const Home = () => {
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      {isMobile && (
        <div className={`absolute inset-0 top-[325px] max-sm:top-[300px] max-sm:flex-col max-sm:items-center max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
          <motion.h2 variants={fadeIn("", "", 0.7, 1)} className={`lg:text-[50px] sm:text-[45px] xs:text-[35px] text-[25px] font-black text-white ml-10 max-sm:ml-0`}>Connect with me</motion.h2>
